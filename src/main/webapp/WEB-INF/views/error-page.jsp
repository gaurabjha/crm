...
<!-- Original:  Maximilian Stocker (maxstocker@reallyusefulcomputing.com) -->
	var x = "${pageContext.request.contextPath }/resources/images/x.jpg";
	// Location of where you uploaded your site's x.jpg image

	var o = "${pageContext.request.contextPath }/resources/images/o.jpg";
	// Location of where you uploaded your site's o.jpg image

	var blank = "${pageContext.request.contextPath }/resources/images/blank.jpg";
			...
			<div id="continer">
				<div id="content">
					...
					<div>
						...
						<h3>
							Enjoy the game or <a
								href="${pageContext.request.contextPath }">Click Here</a> to go
							to home !!
						</h3>
					</div>
					<form name=game>
						<table border=0>
							<td>
								<table border=1>
									<tr>
										<td><a href="javascript:yourChoice('A')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=A alt="Top-Left"></a></td>
										<td><a href="javascript:yourChoice('B')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=B alt="Top-Center"></a></td>
										<td><a href="javascript:yourChoice('C')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=C alt="Top-Right"></a></td>
									</tr>
									<tr>
										<td><a href="javascript:yourChoice('D')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=D alt="Middle-Left"></a></td>
										<td><a href="javascript:yourChoice('E')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=E alt="Middle-Center"></a></td>
										<td><a href="javascript:yourChoice('F')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=F alt="Middle-Right"></a></td>
									</tr>
									<tr>
										<td><a href="javascript:yourChoice('G')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=G alt="Bottom-Left"></a></td>
										<td><a href="javascript:yourChoice('H')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=H alt="Bottom-Center"></a></td>
										<td><a href="javascript:yourChoice('I')"><img
												src="${pageContext.request.contextPath }/resources/images/blank.jpg"
												border=0 height=100 width=100 name=I alt="Bottom-Right"></a></td>
									</tr>
								</table>
							</td>
							<td>
								<table>
									<tr>
										<td><input style="width: 50%" type=text size=5 name=you></td>
										<td>You</td>
									</tr>
									<tr>
										<td><input style="width: 50%" type=text size=5
											name=computer></td>
										<td>Computer</td>
									</tr>
									<tr>
										<td><input style="width: 50%" type=text size=5 name=ties></td>
										<td>Ties</td>
									</tr>
								</table>
							</td>
						...
						&nbsp;&nbsp; <input type=button value="Game Help"
							onClick="help();">
					</form>
	</center>
</body>
